...
func (c *chitChatClient) Join(ctx context.Context, in *JoinRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error) {
...
type ChitChat_JoinClient = grpc.ServerStreamingClient[ChatMessage]

func (c *chitChatClient) Publish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
...
func (c *chitChatClient) Leave(ctx context.Context, in *LeaveRequest, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
...
func (UnimplementedChitChatServer) Join(*JoinRequest, grpc.ServerStreamingServer[ChatMessage]) error {
	return status.Errorf(codes.Unimplemented, "method Join not implemented")
}
func (UnimplementedChitChatServer) Publish(context.Context, *PublishRequest) (*Ack, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Publish not implemented")
}
func (UnimplementedChitChatServer) Leave(context.Context, *LeaveRequest) (*Ack, error) {
...
func _ChitChat_Join_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChitChatServer).Join(m, &grpc.GenericServerStream[JoinRequest, ChatMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChitChat_JoinServer = grpc.ServerStreamingServer[ChatMessage]
